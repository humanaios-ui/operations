...
**Falsifier:** if after the adapter `molt_cycle --read-only` still reports `nf_resolved: 0` against a ledger with ≥1 RESOLVE row, the adapter did not close the edge.
