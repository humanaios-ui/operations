# Ruling request Q-BOARD-RULING-10 — board ruling d10
...
**Source:** `ui/intent-os-humanaios-v3_3.html` · `rulings[d10]` · filed under Z2 ruling d18 (`z1-inbox/2026-09-14/Z2_RULING_INTENTOS_LAUNCH.md`): every board ruling lives in the same queue as every other Z2 decision
**Status:** AWAITING Z2 RATIFICATION

## Question

Option B — ratify the six-pair co-run as a Molt candidate (4-week window, revert if ≥3 pairs r<0.3)?

## Context carried on the board

moves six map rows from REPORTED to VERIFIED-LIVE · 09-15 date is tomorrow
...
2. **By hand:** write the chosen option on the `choice:` line below, then run
   `python3 .z1-control/ratify.py Q-BOARD-RULING-10 --decision ACCEPT --by Night --apply`. The signature covers the
