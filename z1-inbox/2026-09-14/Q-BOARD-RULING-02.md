# Ruling request Q-BOARD-RULING-02 — board ruling d2
...
**Source:** `ui/intent-os-humanaios-v3_3.html` · `rulings[d2]` · filed under Z2 ruling d18 (`z1-inbox/2026-09-14/Z2_RULING_INTENTOS_LAUNCH.md`): every board ruling lives in the same queue as every other Z2 decision
**Status:** AWAITING Z2 RATIFICATION

## Question

TLA_TOOLS_SHA256 — set the repository variable, or drop it as a gate?

## Context carried on the board

gates Q-ORCA-01 · open since 09-06
...
2. **By hand:** write the chosen option on the `choice:` line below, then run
   `python3 .z1-control/ratify.py Q-BOARD-RULING-02 --decision ACCEPT --by Night --apply`. The signature covers the
