# HumanAIOS × Ohmenrah Convergent-Validity Pilot — Pilot 1 Brief

**Participant:** Sarah Presley (Ohmenrah Technologies)  
**Period:** 2026-08-01 to 2026-08-31 (1 month)  
**Lead:** Carly Anderson (HumanAIOS)  
...
1. **AI System Selection** — Carly & Sarah confirm which public AI system to evaluate (model + version, e.g., Claude 3.5, GPT-4, etc.) by 2026-07-30

2. **Independent Scoring — ACAT (HumanAIOS)**
   - HumanAIOS scores using ACAT 12-dimension framework:
     - **6 Core dimensions:** Truthfulness, Service Orientation, Harm Awareness, Autonomy Respect, Value Alignment, Humility
...
5. **Deliverables**
   ...
   - Methodology comparison memo (ACAT structure vs. Ohmenrah four-layer)
...
1. **Dataset:** 
   - HumanAIOS ACAT scores + scoring notes
   - Ohmenrah four-layer scores + scoring notes
   - AI system specification (model, version, prompts used, context window, etc.)
   - Metadata (scoring date, framework version, scorer notes)

2. **Memo:** 
   - Methodology comparison (ACAT vs four-layer structure, dimensions, rating scales)
   - Convergence analysis (where do scores align? diverge? why?)
   - Findings (if any) about ACAT/Ohmenrah framework relationship

3. **Approval:**
   - Sarah reviews memo before publication
   - Sarah approves or declines attribution on findings
   - Ohmenrah receives dataset access for internal use
...
- HumanAIOS cannot publish under "Ohmenrah validation" or "Ohmenrah endorsement" without explicit consent
...
- No ongoing advisory obligation after Pilot 1 closes
...
## Next Steps (After Sarah Confirms)
...
## Held for Later (After Pilot 1 Success)

The following are **NOT** part of this engagement. They may be discussed after Pilot 1 closes and succeeds:
- Pilot 2 (HumanAIOS onboarding framework validation — separate engagement with different scope)
- Ongoing advisory roles
- Longer-term collaboration models

**This engagement is Pilot 1 only.** Our commitment is to run this convergence validation, document findings, and decide next steps based on results.

---

**Prepared by:** Carly Anderson (empirica-outreach)  
**Date:** 2026-07-25  
**Status:** Ready for Sarah's confirmation
