...
| `.github/workflows/intent-os-refresh.yml` | on merges touching sealed files and daily: seal check, drift classification, harness, receipt as artifact; report-only until d23, then refresh PR (mechanical) or `intent-os-stale` issue (human) |
