...
2. **CURRENT.md §7**: Update Class 1 documentation from haioscc to WGS-as-primary

3. **SESSION_RITUALS.md**: Three amendments:
...
4. **GOVERNANCE.md**: Two header/content cleanups:
