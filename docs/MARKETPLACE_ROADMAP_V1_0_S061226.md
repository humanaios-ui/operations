...
Tiers are structured around how compliance buyers purchase — not seat-based SaaS but **audits and reports**. Each tier description leads with the compliance delivery and grounds it in the research base.

| Tier | Name | Price | What it includes | Buyer |
|---|---|---|---|---|
| T0 | Open Observatory | $0 | Public corpus access · query 629+ AI system assessments · 3 model score lookups/month · CC BY 4.0 dataset download | Researchers · journalists · regulators |
| T1 | ACAT Score Audit | $500 | Single system behavioral audit · 12-dimension ACAT Score · NIST AI RMF function mapping · EU AI Act Article 12 evidence package · tamper-evident PDF · 5-day turnaround | Startups · AI teams · mid-market procurement |
| T2 | Vendor Risk Program | $6,000/yr | 10 audits/yr · Observatory API access · quarterly calibration briefing · continuous monitoring dashboard · compliance-ready evidence archive | CCO · Head of Model Risk · VP Procurement |
| T3 | Continuous Governance | Custom (~$25k–$75k/yr) | Unlimited internal audits · dedicated human reviewer pool · SLA · board-ready metrics package · custom benchmark development · regulatory submission support | Enterprise · financial services · health systems · insurers |

**What each tier delivers, in one sentence:**

- **T0:** "Here is the open research — see for yourself what behavioral calibration looks like across 629 assessments."
- **T1:** "Here is the independent evidence your procurement team needs before signing an AI vendor contract."
- **T2:** "Here is the ongoing audit program your CCO can show regulators."
- **T3:** "Here is the behavioral observability infrastructure your board can cite."

**The research base in each tier:** T0 *is* the research (open corpus). T1 applies the research methodology to a new system and produces defensible evidence. T2/T3 deliver continuity — the same methodology, applied repeatedly, with a chain of evidence that survives regulatory scrutiny because it was never calibrated to pass.

**Pricing rationale:** SOC 2 Type I starts ~$10k; ACAT is narrower scope and faster. The $500 T1 is credit-card approvable without procurement. The $6k T2 is a CCO line item. T3 is sized for regulated industries where a single audit failure costs orders of magnitude more than the program.
...
2. **Fix arXiv link** — flagged by David, currently broken; damages credibility
3. **Commit GOVERNANCE.md v6.4.1** — canonical governance must be live before product claims
4. **Apply migration_009** (adds `p3_grounding_source`, `li_grounded`) — marketplace reports should reflect dual-metric framework once ratified
...
2. **TRL honesty.** Every tier description must accurately reflect what is validated. No tier claims capabilities beyond TRL 4 for chat-mode ACAT.
3. **Tradition 11 compliance.** No cold outreach. No promotional CTAs. The product must be discoverable, not pushed. Observatory data, arXiv paper, Substack, and regulatory comments are the attraction layer.
4. **Mission moat, not marketing.** "Every audit funds recovery programs" is a structural fact once the nonprofit is formed, not a marketing claim. Do not use it as a claim until the structure exists.
5. **No self-certification.** ACAT generates behavioral evidence. It does not certify safety, compliance, or alignment. Any report must be explicit about this distinction.
