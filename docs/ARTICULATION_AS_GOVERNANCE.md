...
1. An API/MCP extension concept (`ACAT-GAR`) adding an articulation calibration layer to the assessment pipeline
1. An operations protocol (`OAP`) embedding articulation gates into daily ops (PRs, grants, outreach, 501(c)(3))
