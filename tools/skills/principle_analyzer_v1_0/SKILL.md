...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `principle_analyzer_v1_0` process.
...
python tools/principle_analyzer_v1_0.py --input data/input.json
```
