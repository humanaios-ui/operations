# SKILL: builder_compliance_scanner_v1.0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `builder_compliance_scanner_v1.0` process.
...
| `--path` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/builder_compliance_scanner_v1.0.py --help
```
