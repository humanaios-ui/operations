# SKILL: message_calibration_v1_0

## 1. Description

**What does this tool do?**  
Message calibration scoring tool.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `message_calibration_v1_0` process.
...
python tools/message_calibration_v1_0.py --input data/input.json
```
