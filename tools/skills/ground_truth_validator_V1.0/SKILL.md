# SKILL: ground_truth_validator_V1.0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `ground_truth_validator_V1.0` process.
...
python tools/ground_truth_validator_V1.0.py --help
```
