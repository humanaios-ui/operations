# SKILL: acat_merkle_auditor_v1.0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `acat_merkle_auditor_v1.0` process.
...
python tools/acat_merkle_auditor_v1.0.py --input data/input.json
```
