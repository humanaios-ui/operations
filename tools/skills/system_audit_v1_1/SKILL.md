...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `system_audit_v1_1` process.
...
| `--mode` | `string` | No | `"pre-ratification"` | Command-line option for this tool. |
...
python tools/system_audit_v1_1.py --input data/input.json
```
