# SKILL: bpl_signal_extractor_v1_0

## 1. Description

**What does this tool do?**  
Extracts candidate behavioral-language pattern tokens from response corpora under perturbation sets (H-BPL-01).
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `bpl_signal_extractor_v1_0` process.
...
python tools/bpl_signal_extractor_v1_0.py --input data/input.json
```
