# SKILL: hawkins_acat_mapper_v1_0

## 1. Description

**What does this tool do?**  
Generates evidence-tagged crosswalk reports between ACAT dimensions and Hawkins calibration levels.
...
This tool exists to support the `audit_tool` workflow in this repository and provide repeatable command-line execution for the `hawkins_acat_mapper_v1_0` process.
...
python tools/hawkins_acat_mapper_v1_0.py --input data/input.json
```
