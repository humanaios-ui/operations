# SKILL: acat_psychometric_validator_v1_0

## 1. Description

**What does this tool do?**  
Recomputes reliability (α), PCA, and bi-factor metrics; produces reproducible method report artifacts.
...
This tool exists to support the `validation_tool` workflow in this repository and provide repeatable command-line execution for the `acat_psychometric_validator_v1_0` process.
...
python tools/acat_psychometric_validator_v1_0.py --input data/input.json
```
