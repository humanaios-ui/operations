# SKILL: haios_collab_scanner_v1_0

## 1. Description

**What does this tool do?**  
Scans for collaboration signals across repositories and documents.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `haios_collab_scanner_v1_0` process.
...
| `--sources` | `string` | No | `"gmail` | Command-line option for this tool. |
...
python tools/haios_collab_scanner_v1_0.py --input data/input.json
```
