...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `tool_template` process.
...
python tools/tool_template.py --input data/input.json
```
