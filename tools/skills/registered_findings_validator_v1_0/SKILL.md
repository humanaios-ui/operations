# SKILL: registered_findings_validator_v1_0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `registered_findings_validator_v1_0` process.
...
| `--next-id` | `boolean` | No | `false` | Command-line option for this tool. |
...
python tools/registered_findings_validator_v1_0.py --input data/input.json
```
