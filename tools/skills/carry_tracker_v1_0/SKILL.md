# SKILL: carry_tracker_v1_0

## 1. Description

**What does this tool do?**  
Reads WGS posts, counts sessions-carried per item, flags WARN at N>5 and ESCALATE at N>10.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `carry_tracker_v1_0` process.
...
python tools/carry_tracker_v1_0.py --input data/input.json
```
