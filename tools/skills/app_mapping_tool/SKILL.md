...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `app_mapping_tool` process.
...
python tools/app_mapping_tool.py --help
```
