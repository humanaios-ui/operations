...
```bash
python tools/elicitation_surface_scanner.py --scan tools/acat_mcp_full_wrapper_v1.2.py acat/mcp/wrappers/acat_mcp_wrapper.py tools/supabase_corpus_connector_v1_0.py tools/corpus_integrity_validator.py
python tools/elicitation_surface_scanner.py --smoke-test
```