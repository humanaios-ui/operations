# SKILL: acat_session_validator

## 1. Description

**What does this tool do?**  
Validates session record Phase 1/3 structure, D-COMP declarations, and Merkle chain integrity.
...
This tool exists to support the `validation_tool` workflow in this repository and provide repeatable command-line execution for the `acat_session_validator` process.
...
python tools/acat_session_validator.py --input data/input.json
```
