# SKILL: harm_independence_monitor_v1_0

## 1. Description

**What does this tool do?**  
Tracks PC2-linked Harm Independence Metric (HIM) signal independently of PC1 movement.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `harm_independence_monitor_v1_0` process.
...
python tools/harm_independence_monitor_v1_0.py --input data/input.json
```
