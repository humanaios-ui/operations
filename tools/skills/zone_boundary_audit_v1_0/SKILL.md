# SKILL: zone_boundary_audit_v1_0

## 1. Description

**What does this tool do?**  
Detects Zone 1/2/3 boundary violations in workflow artifacts and operator logs.
...
This tool exists to support the `audit_tool` workflow in this repository and provide repeatable command-line execution for the `zone_boundary_audit_v1_0` process.
...
python tools/zone_boundary_audit_v1_0.py --input data/input.json
```
