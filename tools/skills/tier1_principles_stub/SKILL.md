...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `tier1_principles_stub` process.
...
python tools/tier1_principles_stub.py --help
```
