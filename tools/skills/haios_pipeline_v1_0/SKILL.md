...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `haios_pipeline_v1_0` process.
...
|---|---|---|---|---|
| `--pipeline` | `string` | No | `None` | Command-line option for this tool. |
| `--stages` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/haios_pipeline_v1_0.py --input data/input.json
```
