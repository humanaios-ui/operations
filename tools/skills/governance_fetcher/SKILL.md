...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `governance_fetcher` process.
...
python tools/governance_fetcher.py --input data/input.json
```
