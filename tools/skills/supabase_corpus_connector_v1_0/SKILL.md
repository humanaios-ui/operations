# SKILL: supabase_corpus_connector_v1_0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `supabase_corpus_connector_v1_0` process.
...
| `--report-dir` | `string` | No | `"outputs/"` | Command-line option for this tool. |
| `--count` | `boolean` | No | `false` | Command-line option for this tool. |
| `--validate` | `boolean` | No | `false` | Command-line option for this tool. |
| `--compare-to` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/supabase_corpus_connector_v1_0.py --help
```
