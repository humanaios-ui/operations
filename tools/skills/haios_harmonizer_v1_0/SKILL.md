# SKILL: haios_harmonizer_v1_0

## 1. Description

**What does this tool do?**  
System-level harmonization across governance surfaces.
...
This tool exists to support the `infrastructure_tool` workflow in this repository and provide repeatable command-line execution for the `haios_harmonizer_v1_0` process.
...
|---|---|---|---|---|
| `--state` | `string` | No | `None` | Command-line option for this tool. |
| `--output` | `string` | No | `"outputs/"` | Command-line option for this tool. |
| `--emit-template` | `boolean` | No | `false` | Command-line option for this tool. |
| `--watch` | `boolean` | No | `false` | Command-line option for this tool. |
...
python tools/haios_harmonizer_v1_0.py --help
```
