# SKILL: governance_mapper_v1_0

## 1. Description

**What does this tool do?**  
Maps governance principles to structural roles across documents.
...
This tool exists to support the `governance_tool` workflow in this repository and provide repeatable command-line execution for the `governance_mapper_v1_0` process.
...
python tools/governance_mapper_v1_0.py --input data/input.json
```
