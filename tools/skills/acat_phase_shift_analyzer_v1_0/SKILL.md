# SKILL: acat_phase_shift_analyzer_v1_0

## 1. Description

**What does this tool do?**  
Computes per-agent and per-provider phase shift metrics: LI distributions, stress-response deltas.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `acat_phase_shift_analyzer_v1_0` process.
...
python tools/acat_phase_shift_analyzer_v1_0.py --input data/input.json
```
