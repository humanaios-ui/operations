# SKILL: principle_harmonizer_v1_2
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `principle_harmonizer_v1_2` process.
...
python tools/principle_harmonizer_v1_2.py --input data/input.json
```
