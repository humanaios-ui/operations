# SKILL: run_acat_validation_suite_v1.0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `run_acat_validation_suite_v1.0` process.
...
|---|---|---|---|---|
| `--close-post` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/run_acat_validation_suite_v1.0.py --help
```
