# SKILL: corpus_delta_analyzer

## 1. Description

**What does this tool do?**  
Diffs two corpus CSV snapshots; surfaces LI regression, D-04 patterns, and population change trajectories.
...
This tool exists to support the `diagnostic_tool` workflow in this repository and provide repeatable command-line execution for the `corpus_delta_analyzer` process.
...
|---|---|---|---|---|
| `--before` | `string` | No | `None` | Command-line option for this tool. |
| `--after` | `string` | No | `None` | Command-line option for this tool. |
| `--agent` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/corpus_delta_analyzer.py --help
```
