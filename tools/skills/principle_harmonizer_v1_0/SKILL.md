# SKILL: principle_harmonizer_v1_0

## 1. Description

**What does this tool do?**  
Harmonizes the principle layer across governance files, surfaces drift.
...
This tool exists to support the `governance_tool` workflow in this repository and provide repeatable command-line execution for the `principle_harmonizer_v1_0` process.
...
|---|---|---|---|---|
| `--framework` | `string` | No | `None` | Command-line option for this tool. |
...
| `--list` | `boolean` | No | `false` | Command-line option for this tool. |
...
python tools/principle_harmonizer_v1_0.py --input data/input.json
```
