...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `circuit_validator_v1_0` process.
...
| `--layer` | `string` | No | `"acat"` | Command-line option for this tool. |
...
python tools/circuit_validator_v1_0.py --input data/input.json
```
