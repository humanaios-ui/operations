# SKILL: corpus_integrity_validator

## 1. Description

**What does this tool do?**  
Validates ACAT corpus CSV: missing fields, out-of-range scores, LI correctness, Phase pairing, D-04 monotonicity.
...
This tool exists to support the `validation_tool` workflow in this repository and provide repeatable command-line execution for the `corpus_integrity_validator` process.
...
| `--strict` | `boolean` | No | `false` | Command-line option for this tool. |
...
python tools/corpus_integrity_validator.py --input data/input.json
```
