# SKILL: acat_mcp_full_wrapper_v1.2
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `acat_mcp_full_wrapper_v1.2` process.
...
python tools/acat_mcp_full_wrapper_v1.2.py --help
```
