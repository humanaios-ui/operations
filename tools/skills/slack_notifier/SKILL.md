...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `slack_notifier` process.
...
python tools/slack_notifier.py --input data/input.json
```
