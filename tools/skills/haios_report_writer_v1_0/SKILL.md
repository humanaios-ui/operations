# SKILL: haios_report_writer_v1_0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `haios_report_writer_v1_0` process.
...
| `--pipeline-result` | `string` | No | `None` | Command-line option for this tool. |
| `--format` | `string` | No | `"markdown"` | Command-line option for this tool. |
| `--output-dir` | `string` | No | `"/tmp/haios_reports"` | Command-line option for this tool. |
...
python tools/haios_report_writer_v1_0.py --input data/input.json
```
