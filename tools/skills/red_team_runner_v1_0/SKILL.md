...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `red_team_runner_v1_0` process.
...
python tools/red_team_runner_v1_0.py --input data/input.json
```
