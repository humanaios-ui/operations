# SKILL: governance_mapper_uber_v1_1
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `governance_mapper_uber_v1_1` process.
...
python tools/governance_mapper_uber_v1_1.py --input data/input.json
```
