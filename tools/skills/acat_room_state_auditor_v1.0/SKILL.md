# SKILL: acat_room_state_auditor_v1.0
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `acat_room_state_auditor_v1.0` process.
...
|---|---|---|---|---|
| `--room` | `string` | No | `None` | Command-line option for this tool. |
...
python tools/acat_room_state_auditor_v1.0.py --help
```
