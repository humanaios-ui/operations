# SKILL: mhr_question_trace_v1_0

## 1. Description

**What does this tool do?**  
Traces question-source → method-design → data-output chain for Market-Harmonic Research auditability.
...
This tool exists to support the `audit_tool` workflow in this repository and provide repeatable command-line execution for the `mhr_question_trace_v1_0` process.
...
python tools/mhr_question_trace_v1_0.py --input data/input.json
```
