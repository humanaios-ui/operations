# SKILL: anthropic_client_fence_fix
...
This tool exists to support the `tool` workflow in this repository and provide repeatable command-line execution for the `anthropic_client_fence_fix` process.
...
python tools/anthropic_client_fence_fix.py --help
```
