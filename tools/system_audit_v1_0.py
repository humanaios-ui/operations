...
Single-command pre-flight: GitHub API health, Supabase row count, CF
zone, Make last-run, CURRENT.md age. PASS/WARN/FAIL in under 30
seconds.

Usage:
  python system_audit_v1_0.py --input <path_or_json>
  python system_audit_v1_0.py --smoke-test
  python system_audit_v1_0.py --help
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"System Audit — v1.0 v1.0.0"
    )
    parser.add_argument(
        "--input", "-i",
