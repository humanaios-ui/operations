#!/usr/bin/env python3
"""
Molting Protocol Diff — v1.0
Builder v1.7 compliant · audit_tool
HumanAIOS · S-060126-01

Compare SESSION_RITUALS protocol versions for additive patching
versus clean-layer replacement.
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"Molting Protocol Diff — v1.0 v1.0.0"
    )
    parser.add_argument(
        "--input", "-i",
