...
Takes URL or file to external governance doc, runs
document_analyzer, classifies governance lane, produces GROW/KILL
verdict.

Usage:
  python governance_mapper_v1_0.py --input <path_or_json>
  python governance_mapper_v1_0.py --smoke-test
  python governance_mapper_v1_0.py --help
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description=f"Governance Mapper — v1.0 v1.0.0"
    )
    parser.add_argument(
        "--input", "-i",
