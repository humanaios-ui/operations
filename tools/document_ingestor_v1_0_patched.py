...
VALID_LAYERS = {
    "behavioral_session",   # canonical corpus rows
    "governance_document",  # governance specs and research papers
    "commercial_legal",     # legal/commercial instruments
    "partner_review",       # Mode AI / partner submissions (Z2-TRUST-A)
    "staging",              # multi-provider quarantine (Z2-TRUST-B)
}
