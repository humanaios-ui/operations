"""
Triage Log Service
Builder v1.7 compliant — triage_log_service_tool
HumanAIOS — S-070726-triage-log-service
...
def run_smoke_test() -> None:
    """Minimal smoke test — verifies constants and class are importable."""
    assert VALID_GATE_VERDICTS, "VALID_GATE_VERDICTS must be non-empty"
