...
1. Build prompt
1. Call LLM → reasoning trace
1. Parse ACAT_PRE / LI_ESTIMATE / CALIBRATION_MODE from reasoning → P1 Supabase write
1. Parse forecast from reasoning → Metaculus submit → P2 Supabase write
1. P3 scores = P1 scores (placeholder, LI=1.0) → comment → P3 Supabase write
1. Phase 4 handled by phase4_resolution_sweep.py (daily cron)
