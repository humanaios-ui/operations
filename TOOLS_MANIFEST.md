...
| HAIOS-TOOL-153 | z1_ratify | `.z1-control/ratify.py` | 1.1.0 | 2 | draft | **pending-Z2**, no-builder-markers | Record a Z2 decision on a candidate block. Run by Z2, not by Z1. |
