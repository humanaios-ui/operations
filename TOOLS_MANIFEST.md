...
| tool_id | tool | path | ver | zone | status | flags | purpose |
|---|---|---|---|---|---|---|---|
| HAIOS-TOOL-051 | decision_relay | `tools/decision_relay.py` | 0.3.0 | 1 | draft | — | decision_relay.py — routes Z2 decisions from the Intent-OS board to a GitHub PR, behind ngrok. |
